...
class Ion_auth_model extends CI_Model {
    ...
    public function login($identity, $password, $remember = FALSE) {
        ...
        $query = $this->db->select($this->identity_column . ', email, id, id_bank, id_broker, id_asuransi, password,username,company,first_name,last_name, active, last_login')
                ->where($this->identity_column, $identity)
                ->limit(1)
                ->order_by('id', 'desc')
                ->get($this->tables['tb_users']);
    ...
    public function set_session($user) {
        ...
        $session_data = array(
            ...
            'bank_id' => $user->id_bank,
            'broker_id' => $user->id_broker,
            'asuransi_id' => $user->id_asuransi,
