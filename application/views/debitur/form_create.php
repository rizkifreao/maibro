                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"><!-- Kolom 1 -->
                                    ...
                                    <div class="form-group <?=form_error('KTP') ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="number" name="KTP" value="<?php echo set_value('KTP');?>" class="form-control" placeholder="Masukan Nomor KTP" required>
                                        <!-- validasi eror -->
                                    ...
                                    <div class="form-group <?=form_error('email') ? 'has-error' : ''; ?>">
                                        <label>Email</label>
                                        <input type="email" name="email" value="<?php echo set_value('email'); ?>" class="form-control" placeholder="Masukan Email" required>
                                        <!-- validasi eror -->
                                    ...
                                    <div class="form-group <?=form_error('alamat') ? 'has-error' : ''; ?>">
                                        <label>Alamat</label>
                                        <textarea type="text" name="alamat" value="<?php echo set_value('alamat');?>" class="form-control" placeholder="Masukan Alamat" required><?=set_value('alamat');?></textarea>
                                        <!-- validasi eror -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group <?=form_error('jk') ? 'has-error' : ''; ?>">
                                        ...
                                        <select name ="jk" value="<?php echo set_value('jk');?>"  class="form-control select2" style="width: 100%;" required>
                                            ...
                                            <option value="Pria" <?=(set_value('jk') == "Pria") ? 'selected' : '';?>>Pria</option>
                                            <option value="Wanita"<?=(set_value('jk') == "Wanita") ? 'selected' : '';?> >Wanita</option>                                            
                                        </select>
                                        <!-- validasi eror -->
                                    ...
                                    <div class="form-group <?=form_error('tmp_lahir') ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="text" name="tmp_lahir" value="<?php echo set_value('tmp_lahir'); ?>" class="form-control" placeholder="Masukan Kota Kelahiran" required>
                                        <!-- validasi eror -->
                                    ...
                                    <div class="form-group <?=form_error('tlp') ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="number" name="tlp" class="form-control" value="<?php echo set_value('tlp');?>" placeholder="Masukan Nomor Telepon" required>
                                        <!-- validasi eror -->
                                    ...
                                    <div class="form-group <?=form_error('umur') ? 'has-error' : ''; ?>">
                                        <label>Umur</label>
                                        <input type="number" name="umur" class="form-control" value="<?php echo set_value('umur');?>" placeholder="Masukan Umur" required>
                                        <!-- validasi eror -->
