...
<section class='content'>
    <div class='row'>
	    ...
	    <tbody>
			...
			echo '  '; 
			echo anchor(site_url('groups/update/'.$groups->id),'<i class="fa fa-pencil-square-o"></i>',array('data-toggle'=>'tooltip','title'=>'edit','class'=>'btn btn-warning btn-sm')); 
			echo '  '; 
			echo anchor(site_url('groups/delete/'.$groups->id),'<i class="fa fa-trash-o"></i>','data-toggle="tooltip" title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
											<?php
