                       ...
                       foreach ($record as $r){    
                        $katmenu = $r->parent == 0 ? 'Menu Utama' : chek($r->parent);
                           echo"
                               ...
                               <td>".$r->link."</td>
                               <td>".$katmenu."</td>                                                       
                               <td>" . anchor('menu/edit/' . $r->id_menu, '<i class="btn btn-warning btn-xs glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                               <td>" . anchor('menu/delete/' . $r->id_menu, '<i class="btn-xs btn-danger glyphicon glyphicon-trash" data-toggle="tooltip" title="Delete"></i>', array('onclick' => "return confirm('Data Akan di Hapus?')")) . "</td>
                               </tr>";
                           $no++;
                       }
                       ?>
