            ...
            "columns": [
                ...
                },
                {
                    ...
                    "mRender": function (data) {
                        ...
                        <a data-id="'+ data +'" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalForm" onclick="getDetail(this)" title="Revisi"><i class="fa fa-send-o"></i> Revisi</a> \n\
                        <a href="<?=base_url('produksi/approve')?>/'+ data +'" class="btn btn-xs bg-navy disable color-palette" title="Approve"><i class="glyphicon glyphicon glyphicon-ok"></i> Approve</a>';
                    }
                }
            ],
            "order": [[1, 'desc']],
