...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?=site_url('');?>klaimjiwa"> Asuransi Jiwa </a></li>
                ...
                <div class="row">
                    <div class="col-md-6"><!-- Kolom 1 -->
                        ...
                        <div class="form-group <?=form_error('nokredit') ? 'has-error' : ''; ?>">
                            ...
                            <input type="number" name="nokredit" class="form-control" value="<?php echo set_value('nokredit'); echo $klaim['nokredit']; ?>" placeholder="Masukan Nomor Kredit" required>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('tenor') ? 'has-error' : ''; ?>">
                            ...
                            <input type="number" name="tenor" class="form-control" value="<?php echo set_value('tenor'); echo $klaim['tenor']; ?>" placeholder="Masukan Masa Kredit" required>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('plafon') ? 'has-error' : ''; ?>">
                            ...
                            <input type="plafon" name="plafon" class="form-control" value="<?php echo set_value('plafon'); echo $klaim['plafon']; ?>" placeholder="Masukan Plafon Pinjaman" required>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('premi') ? 'has-error' : ''; ?>">
                            <label>Premi</label>
                            <input type="number" name="premi" class="form-control" value="<?php echo set_value('premi'); echo $klaim['premi']; ?>" placeholder="Masukan Premi" required>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('nilai_klaim') ? 'has-error' : ''; ?>">
                            ...
                            <input type="number" name="nilai_klaim" class="form-control" value="<?php echo set_value('nilai_klaim'); $klaim['nilai_klaim']; ?>" placeholder="Masukan Jumlah Klaim" required>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Surat Kepesertaan (e-policy)</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/e-policy/' . $student['p_ep'])) { ?>
                                <a href="<?=site_url('public/documents/e-policy/' . $student['p_ep'])?>" target="_blank" ><?=$student['p_ep']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_ep" accept="application/pdf">
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Surat Keterangan Kematian</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/suratKematian/' . $student['p_skk'])) { ?>
                                <a href="<?=site_url('public/documents/suratKematian/' . $student['p_skk'])?>" target="_blank" ><?=$student['p_skk']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_skk" accept="application/pdf">
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">KTP Identitas Debitur</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/ktp/' . $student['p_ktp'])) { ?>
                                <a href="<?=site_url('public/documents/ktp/' . $student['p_ktp'])?>" target="_blank" ><?=$student['p_ktp']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_ktp" accept="application/pdf">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group <?=form_error('jns_kredit') ? 'has-error' : ''; ?>">
                            ...
                            <select name ="jns_kredit" value="<?php echo set_value('jns_kredit');?>"  class="form-control select2" style="width: 100%;" required>
                                ...
                                <option value="INDEMNITY" <?=($klaim['jns_kredit']) ? 'selected':''?>>INDEMNITY</option>
                                <option value="UP TETAP"<?=($klaim['jns_kredit']) ? 'selected':''?> >UP TETAP</option>                                            
                            </select>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('jns_klaim') ? 'has-error' : ''; ?>">
                            ...
                            <select name ="jns_klaim" value="<?php echo set_value('jns_klaim');?>"  class="form-control select2" style="width: 100%;" required>
                                <option value="1">-- Piih --</option>
                                <option value="MENINGGAL NORMAL" <?=($klaim['jns_klaim']) ? 'selected':''?>>MENINGGAL NORMAL</option>
                                <option value="MENINGGAL KECELAKAAN"<?=($klaim['jns_klaim']) ? 'selected':''?> >MENINGGAL KECELAKAAN</option> 
                                <option value="MACET / PHK"<?=($klaim['jns_klaim']) ? 'selected':''?> >MACET / PHK</option>                                            
                            </select>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('tgl_akad') ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="tgl_akad" value="<?php echo set_value('tgl_akad'); echo $klaim['tgl_akad'];?>" class="form-control pull-right" id="tgl_akad" placeholder="Pilih Tanggal" required>
                            </div>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('tgl_lapor') ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="tgl_lapor" value="<?php echo set_value('tgl_lapor'); echo $klaim['tgl_lapor'];?>" class="form-control pull-right" id="tgl_lapor" placeholder="Pilih Tanggal" required>
                            </div>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group <?=form_error('tgl_kejadian') ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="tgl_kejadian" value="<?php echo set_value('tgl_kejadian'); echo $klaim['tgl_kejadian'];?>" class="form-control pull-right" id="tgl_kejadian" placeholder="Pilih Tanggal" required>
                            </div>
                            <!-- validasi eror -->
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Surat Pengajuan Klaim</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/spk/' . $student['p_spk'])) { ?>
                                <a href="<?=site_url('public/documents/spk/' . $student['p_spk'])?>" target="_blank" ><?=$student['p_spk']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_spk"  accept="application/pdf" >
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Catatan / Historical Angsuran</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/historical/' . $student['p_ha'])) { ?>
                                <a href="<?=site_url('public/documents/historical/' . $student['p_ha'])?>" target="_blank" ><?=$student['p_ha']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_ha" accept="application/pdf">
                        ...
                        <div class="form-group">
                          <label for="exampleInputFile">Photo Saat Akad Kredit</label>
                            <?php if ($this->uri->segment(2) == 'edit') { ?>
                              <?php if (file_exists('./public/documents/photokredit/' . $student['p_ak'])) { ?>
                                <a href="<?=site_url('public/documents/photokredit/' . $student['p_ak'])?>" target="_blank" ><?=$student['p_ak']?></a>
                              <?php } ?>
                                <input type="file" id="exampleInputFile" name="p_ak" accept="application/pdf">
            ...
            <div class="box-footer">
              <div class="col-md-12">
                <div class="text-center">
                  <a href="<?=site_url('klaimjiwa');?>" class="btn btn-default">BATAL</a>
