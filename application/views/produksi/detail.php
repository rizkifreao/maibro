    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <a href="<?=site_url('produksi');?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
          <a href="<?=site_url('produksi/update').'/'.$this->uri->segment(3);?>" class="btn btn-warning"><i class="fa fa-edit"></i> Update</a>
        </div>
        <div class="box-header">
